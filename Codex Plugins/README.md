...
| `dhandy-excel-quote-template` | 단디메카 Excel 견적서 표준 포맷 기반 견적서·PDF 생성 | `$artifact-template-dhandy` | `1.0.0+codex.20260723023458` |
...
3. 템플릿을 바꾸면 미리보기, 관련 기준 파일 및 스킬 지침도 함께 점검합니다.
